...
func Huh(env gui.Env, theme *Theme, action func()) {
	iconImg := MakeIconImage("volume_lvl-8")

	redraw := func(r image.Rectangle, over, pressed bool) func(draw.Image) image.Rectangle {
		return func(drw draw.Image) image.Rectangle {

			draw.Draw(drw, r, &image.Uniform{theme.VolumeBg}, image.Point{}, draw.Src)
...
func Slider(env gui.Env, theme *Theme, pausebtn <-chan bool, action func(bool)) {
